        ...
        <div class="sidebar-informasi-layout">
            <div class="sidebar-informasi-overflow">
                ...
                <div class="sidebar-informasi-box">
                    ...
                    <div class="sidebar-informasi__desc">
                        <h4>{{ $carts['nama'] }}</h4>
                        <span>{{ $carts['size'] }} {{ $carts['color'] }}</span>
                        <span>{{ $carts['qty'] }} Pcs</span>
                        <span class="price-mobile-sidebar">Rp. {{ number_format($carts['price']) }} ,-</span>
                    </div>
                    <div class="sidebar-informasi__price">
                        <span>Rp. {{ number_format($carts['price']) }} ,-</span>
                    </div>
                </div>
            </div>
            <div class="sidebar-informasi__total">
                <div class="sidebar-informasi__total-box">
                    <span>Berat</span>
                    <span>{{number_format($carts['package_weight'])}} /g</span>
                </div>
            </div>
            <div class="sidebar-informasi__total">
                <div class="sidebar-informasi__total-box">
            ...
            <div class="sidebar-informasi__total sidebar-informasi__total-main">
                <div class="sidebar-informasi__total-box">
                    <span>Total</span>
                    <span>Rp. {{ number_format($carts['price_total']+$cost) }} ,-</span>
                </div>
            </div>
        </div>
    </div>
