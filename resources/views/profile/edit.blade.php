                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                                <div class="row gap-3">
                                    ...
                                    <div class="col-md-12"><button class="btn w-100 btn-light border text-start" onclick="showTab('gambar_product')">Update Password</button></div>
                                </div>
                        </div>
                        <div class="col-md-8 border p-4">
                            <form id="productForm" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" value="{{ auth()->user()->no_wa }}" class="form-control" id="no_wa" name="no_wa" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                            ...
                                            <div class="select-style">
                                                <select name="province_code" class="form-control" id="provinsi" required>
                                                    ...
                                                    <option value="{{ $prov['province_id'] }}" {{ ($prov['province_id'] == auth()->user()->code_province)?'selected':'' }}>{{ $prov['province'] }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="select-style">
                                                <select name="city_code" class="form-control" id="city">
                                                    ...
                                                    <option value="{{ $city['city_id'] }}" {{ ($city['city_id'] == auth()->user()->code_city)?'selected':'' }}>{{ $city['city_name'] }}</option>
                                                    @endforeach
                                                </select>
                                                <iconify-icon icon="octicon:chevron-down-12"></iconify-icon>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="select-style">
                                                <select name="subdistrict_code" class="form-control" id="subdistrict">
                                                    ...
                                                    <option value="{{ $subdistrict['subdistrict_id'] }}" {{ ($subdistrict['subdistrict_id'] == auth()->user()->code_subdistrict)?'selected':'' }}>{{ $subdistrict['subdistrict_name'] }}</option>
                                                    @endforeach
                                                </select>
                                                <iconify-icon icon="octicon:chevron-down-12"></iconify-icon>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nomor_rekening" value="{{ auth()->user()->nomor_rekening }}" name="nomor_rekening" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="account_holders_name" class="form-label">Account Holder's Name:</label>
                                                <input type="text" class="form-control" id="account_holders_name"  value="{{ auth()->user()->account_holders_name }}" name="account_holders_name" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="editor" class="form-label">Address:</label>
                                        <textarea class="form-control" id="editor" name="address" required>{{ auth()->user()->account_holders_name }}</textarea>
                                    </div>
                                </div>
                            </form>
