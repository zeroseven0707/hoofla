...
<div class="container mt-5">
    <form action="/transaction-dropshipper" method="GET" class="d-flex gap-4" style="align-items: center;">
            ...
            <table class="table table-bordered mt-4">
                ...
                @foreach($transaction as $key => $transaction)
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pengirim{{ $transaction->id }}">
                                Lihat Detail Pengirim
                            </button>
                            <!-- Modal -->
                            <div class="modal fade modal-fullscreen-sm-down" id="pengirim{{ $transaction->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Informasi Pengirim</h5>
                                        ...
                                        <div class="modal-body">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    <td>{{ $transaction->drop->name }}</td>
                                                    <td>{{ $transaction->drop->city }}, {{ $transaction->drop->subdistrict }}, {{ $transaction->drop->address }}</td>
                                                    <td>{{ $transaction->drop->no_telp }}</td>
