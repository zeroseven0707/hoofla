...
<div class="container mt-5">
    <ul class="nav nav-tabs" id="myTabs">
        <li class="nav-item">
            <a class="nav-link active" id="inactive-tab" data-bs-toggle="tab" href="#inactiveResellers">Nonactive Distributor</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="active-tab" data-bs-toggle="tab" href="#activeResellers">Active Distributor</a>
        </li>
    </ul>
